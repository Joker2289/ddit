...
public class ConditionalStatement {
	...
	public static void main(String[] args) {
		...
		int o = 1;		// 나머지 - if문 결과값이 false이므로 블럭안의 문장을 수행하지 않고 else로 넘어가 블럭안의 문장을 수행한다
		if(o == 0){
			System.out.println("영");
		}else{
...
//		gradingUpgrade();
	...
	private static void gradingUpgrade() {
			...
			System.out.println("당신의 점수는 "+score+" 입니다");	// println 은 화면 출력할 때 줄바까서 출력
			if(score >= 90){
				grade = 'A';
						if(score >= 98){
							opt = '+';
			...
			System.out.printf("당신의 학점은 "+ grade + opt +" 입니다"); // printf
