...
/*		   [2-3] 다음의 문장에서 리터럴, 변수, 상수, 키워드를 적으시오.
			...
			b. Byte
			c. double
			d. boolean			답 : Byte - 타입은 대문자를 쓸 수 없음
			...
			[2-6] 다음 중 키워드가 아닌 것은?(모두 고르시오)
				...
				c. NULL
				d. Class
				e. System 				답 : system, True, NULL, Class
			...
			[2-7] 다음 중 변수의 이름으로 사용할 수 있는 것은? (모두 고르시오)
				...
				f. new
				g. $MAX_NUM
				h. hello@com			답 : $ystem, If, 자바, $MAX_NUM
			...
			[2-12] 다음 중 main메서드의 선언부로 알맞은 것은? (모두 고르시오)
				...
				e. static public void main(String[] args)	답 : a, *
